...
var match = countInputs(unusedAfter) !== 1;

ReactDOMRe.renderToElementWithId("This number should be '1' if you are running the production build you will see something else! ->" + (String(countInputs(unusedAfter)) + (
        match ? "<- THATS NOT GOOD!!!!" : "<- Looks like all is well"
      )), "root");
